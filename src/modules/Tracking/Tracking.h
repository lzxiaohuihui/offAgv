...
private:
    bool findDataAssociation(cv::Mat &ICP_ref_pts, cv::Mat &ICP_new_pts, vector<cv::Point> &nearest_pts, int knn, float &err);
    ...
    const int MIN_NOEMPTY_PIXEL = 1000;
